              ...
              Container(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('User Name',style: TextStyle(color: Colors.white,fontSize: 40),),
                    Text('Emp. Id',style: TextStyle(color: Colors.white,fontSize: 30)),
                    Text('Email Id',style: TextStyle(color: Colors.white,fontSize: 20))
                  ],
                ),
